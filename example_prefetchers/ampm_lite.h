...
void ampm_l2_prefetcher_initialize(int cpu_num)
{
...
void ampm_l2_prefetcher_operate(int cpu_num, unsigned long long int addr, unsigned long long int ip, int cache_hit)
{
