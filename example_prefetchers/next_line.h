...
void nextline_l2_prefetcher_initialize(int cpu_num)
{
...
void nextline_l2_prefetcher_operate(int cpu_num, unsigned long long int addr, unsigned long long int ip, int cache_hit)
{
  ...
  fake_l2_prefetch_line(0, addr, ((addr>>6)+1)<<6, FILL_L2, NEXTLINE);
}
